...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, hasProtocol, withHttps, withoutTrailingSlash, decodePath, withLeadingSlash, withoutProtocol, withTrailingSlash, withBase, parsePath, parseQuery, stringifyQuery, encodePath, stringifyParsedURL } from 'file:///Users/weblib/Desktop/health/node_modules/ufo/dist/index.mjs';
import { createStorage, defineDriver, prefixStorage } from 'file:///Users/weblib/Desktop/health/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/weblib/Desktop/health/node_modules/unstorage/drivers/fs.mjs';
import crypto from 'node:crypto';
import fsDriver from 'file:///Users/weblib/Desktop/health/node_modules/unstorage/drivers/fs-lite.mjs';
import lruCache from 'file:///Users/weblib/Desktop/health/node_modules/unstorage/drivers/lru-cache.mjs';
...
import { toValue } from 'file:///Users/weblib/Desktop/health/node_modules/vue/index.mjs';
import { createConsola } from 'file:///Users/weblib/Desktop/health/node_modules/consola/dist/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname, resolve as resolve$1 } from 'file:///Users/weblib/Desktop/health/node_modules/pathe/dist/index.mjs';
...
const _47Users_47weblib_47Desktop_47health_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js = defineDriver(
  /**
...
storage.mount('internal:nuxt:prerender', _47Users_47weblib_47Desktop_47health_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js({"driver":"/Users/weblib/Desktop/health/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js","base":"/Users/weblib/Desktop/health/.nuxt/cache/nitro/prerender"}));
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "d60efe59-1678-4d1e-900d-40420b38d6c4",
    ...
    "routeRules": {
      ...
      "/sitemap.xml": {
        "headers": {
          ...
          "X-Sitemap-Prerendered": "2025-11-27T08:57:21.614Z"
        }
      },
      "/_nuxt": {
        "robots": "noindex",
...
const assets = {
  "/__sitemap__/style.xsl": {
    ...
    "etag": "\"1768-4rJe2Bv27l6Z/YR/261hB++wiEU\"",
    "mtime": "2025-11-27T08:57:23.934Z",
    "size": 5992,
...
const _lazy_g1Zvt0 = () => import('../_/renderer.mjs');
