...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getQuery as getQuery$1, readBody, getRequestHost, getRequestProtocol, setHeader, getHeader, getResponseStatus, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getResponseStatusText } from 'file:///Users/weblib/Desktop/health/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve as resolve$1, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/weblib/Desktop/health/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/weblib/Desktop/health/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, hasProtocol, withHttps, withoutTrailingSlash, withTrailingSlash, decodePath, withLeadingSlash, joinRelativeURL, withoutProtocol, withBase, parsePath, parseQuery, stringifyQuery, encodePath, stringifyParsedURL } from 'file:///Users/weblib/Desktop/health/node_modules/ufo/dist/index.mjs';
import process$1 from 'node:process';
import { renderToString } from 'file:///Users/weblib/Desktop/health/node_modules/vue/server-renderer/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/weblib/Desktop/health/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/weblib/Desktop/health/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/weblib/Desktop/health/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/weblib/Desktop/health/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/weblib/Desktop/health/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/weblib/Desktop/health/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///Users/weblib/Desktop/health/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/weblib/Desktop/health/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file:///Users/weblib/Desktop/health/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/weblib/Desktop/health/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/weblib/Desktop/health/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/weblib/Desktop/health/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { createConsola, consola as consola$1 } from 'file:///Users/weblib/Desktop/health/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/weblib/Desktop/health/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/weblib/Desktop/health/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/weblib/Desktop/health/node_modules/source-map/source-map.js';
import devalue from 'file:///Users/weblib/Desktop/health/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { toValue, isVNode, isRef } from 'file:///Users/weblib/Desktop/health/node_modules/vue/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/weblib/Desktop/health/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/weblib/Desktop/health/node_modules/errx/dist/index.js';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$2 } from 'file:///Users/weblib/Desktop/health/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/weblib/Desktop/health/node_modules/unhead/dist/server.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Users/weblib/Desktop/health/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///Users/weblib/Desktop/health/node_modules/unhead/dist/utils.mjs';
import Fuse from 'file:///Users/weblib/Desktop/health/node_modules/fuse.js/dist/fuse.mjs';
import { diffLines } from 'file:///Users/weblib/Desktop/health/node_modules/diff/libesm/index.js';
import MagicString from 'file:///Users/weblib/Desktop/health/node_modules/magic-string/dist/magic-string.es.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/weblib/Desktop/health/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/weblib/Desktop/health","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/weblib/Desktop/health/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/weblib/Desktop/health/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/weblib/Desktop/health/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/weblib/Desktop/health/.data/kv"}));
...
const _inlineRuntimeConfig = {
    ...
    "routeRules": {
      ...
      "/sitemap.xml": {
        "headers": {
          ...
          "X-Sitemap-Prerendered": "2026-01-29T06:49:34.908Z"
        }
      },
      "/_nuxt": {
        "robots": "noindex",
  ...
  "public": {
    ...
    "nuxt-link-checker": {
      ...
      "rootDir": "/Users/weblib/Desktop/health",
      "excludeLinks": [],
      "skipInspections": [],
      "fetchTimeout": 10000,
...
const _g2lHHWclBhbHHlwrOmFlmX0F0xPKaikO5qd1I2UrBc = (function(nitro) {
...
const _VdPfYuJ1tM06GeyO8IkqNP1dDrzNsrt93gvZ96d3KY = defineNitroPlugin(async (nitroApp) => {
...
const _b0h0L70B7SRB1lw2G14eyLW6nPAejQIciwxQxavRM = defineNitroPlugin(async (nitroApp) => {
...
const rootDir = "/Users/weblib/Desktop/health";
...
const _8E9EVD_ZXYNlSyIU949h6hqWguGwZAhCqdRa1ZULg4 = (nitroApp) => {
...
const plugins = [
  _g2lHHWclBhbHHlwrOmFlmX0F0xPKaikO5qd1I2UrBc,
_VdPfYuJ1tM06GeyO8IkqNP1dDrzNsrt93gvZ96d3KY,
_b0h0L70B7SRB1lw2G14eyLW6nPAejQIciwxQxavRM,
_8E9EVD_ZXYNlSyIU949h6hqWguGwZAhCqdRa1ZULg4
];
...
const _SBOvVb = eventHandler((event) => {
...
const getClientManifest = () => import('file:///Users/weblib/Desktop/health/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _A_JRXE = eventHandler(async (e) => {
  if (e.context._initedSiteConfig)
    return;
...
const _QhrqjG = eventHandler(async (e) => {
...
const _m_EpTK = defineEventHandler(async (e) => {
  const nitroApp = useNitroApp();
...
const _q23trL = defineEventHandler(async (e) => {
...
const _p0jcbg = defineEventHandler(async (e) => {
...
const _JQuC3A = defineEventHandler(async (e) => {
  const query = getQuery$1(e);
...
async function parseSitemapXml(xml) {
  ...
  const { XMLParser } = await import('file:///Users/weblib/Desktop/health/node_modules/fast-xml-parser/src/fxp.js');
...
const _da0G7q = defineEventHandler(async (e) => {
...
const _cRt_Dp = defineEventHandler(async (e) => {
...
const _hdcySP = defineEventHandler(async (e) => {
...
const _mgQcIu = defineEventHandler(async (e) => {
  const nitroOrigin = useNitroOrigin(e);
  return {
    nitroOrigin,
...
const _1wObyp = defineEventHandler(async (e) => {
...
const pagePaths = [
  ...
  {
    "title": "",
    "link": "/services/general-health"
  }
];

const _RwVSCp = defineCachedEventHandler(async (e) => {
  const runtimeConfig = useRuntimeConfig().public["nuxt-link-checker"] || {};
  const linkDb = [
    ...pagePaths
  ];
...
const _T3Kt66 = defineEventHandler(async (e) => {
  return {
    runtimeConfig: useRuntimeConfig(e).public["nuxt-link-checker"]
  };
});

const _lazy_rJtvy2 = () => Promise.resolve().then(function () { return contactAi_post$1; });
const _lazy_g1Zvt0 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _SBOvVb, lazy: false, middleware: true, method: undefined },
  { route: '/api/contact-ai', handler: _lazy_rJtvy2, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_g1Zvt0, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _A_JRXE, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _QhrqjG, lazy: false, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _m_EpTK, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _q23trL, lazy: false, middleware: true, method: undefined },
  { route: '/__robots__/debug.json', handler: _p0jcbg, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug-path.json', handler: _JQuC3A, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _da0G7q, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _cRt_Dp, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _hdcySP, lazy: false, middleware: false, method: undefined },
  { route: '/__schema-org__/debug.json', handler: _mgQcIu, lazy: false, middleware: false, method: undefined },
  { route: '/__link-checker__/inspect', handler: _1wObyp, lazy: false, middleware: false, method: undefined },
  { route: '/__link-checker__/links', handler: _RwVSCp, lazy: false, middleware: false, method: undefined },
  { route: '/__link-checker__/debug.json', handler: _T3Kt66, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_g1Zvt0, lazy: true, middleware: false, method: undefined }
];
...
const sources$1 = [
    ...
    },
    {
        ...
        "urls": [
            ...
            {
                "loc": "/services/diet-nutrition"
            },
            {
                "loc": "/services/general-health"
            }
        ],
        "sourceType": "app"
    }
...
const contactAi_post = defineEventHandler(async (event) => {
  var _a, _b, _c, _d, _e, _f, _g;
  const payload = await readBody(event);
  const { message } = payload != null ? payload : {};
...
Patient Name: ${(_a = payload.name) != null ? _a : "Not provided"}
Email: ${(_b = payload.email) != null ? _b : "Not provided"}
Phone: ${(_c = payload.phone) != null ? _c : "Not provided"}
`;
  if (!openAiKey) {
    return {
  ...
  const suggestion = ((_g = (_f = (_e = (_d = data == null ? void 0 : data.choices) == null ? void 0 : _d[0]) == null ? void 0 : _e.message) == null ? void 0 : _f.content) != null ? _g : "").trim();
  return {
...
const contactAi_post$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: contactAi_post
}, Symbol.toStringTag, { value: 'Module' }));
